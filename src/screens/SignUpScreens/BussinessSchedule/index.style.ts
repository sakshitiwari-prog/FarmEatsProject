...
const styles = StyleSheet.create({
  ...
  BusinessHrsContainer:{
    width:responsiveWidthWrtScreen(41),
    paddingVertical:responsiveWidthWrtScreen(2.8),
    borderRadius: 8,
    display:'flex',
  ...
  dayContainer: {
    paddingVertical: responsiveHeightWrtScreen(0.8),
    minWidth:responsiveWidthWrtScreen(9),
    marginRight: responsiveWidthWrtScreen(1),
    borderRadius: 8,
    display:'flex',
    justifyContent:'center',
    alignItems:'center'
  ...
  middlePart: {
    marginTop: responsiveHeightWrtScreen(0),
  },
  upperPart: {
    display: 'flex',
    flexDirection: 'column',
